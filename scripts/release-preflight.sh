...
grep -E '^    const val DEBIAN_VERSION = "[^"]+"' "$MANIFEST" >/dev/null
grep -E '^    const val DEBIAN_URL = "https://images\.linuxcontainers\.org/images/debian/bookworm/arm64/default/.+/rootfs\.tar\.xz"' "$MANIFEST" >/dev/null
